...
diamond_data <- ggplot(data = diamonds_sample)


# Draw a scatter plot (with point geometry) with for the `diamonds_sample` set, 
# with the `carat` mapped to the x-position and `price` mapped to the y-position.
diamond_data + geom_point(mapping = aes(x = carat, y = price))
...
diamond_data +
  geom_point(mapping = aes(x = carat, y = price, size = carat))
...
diamond_data +
  ...
  geom_smooth(mapping = aes(x = carat, y = price), na.rm = TRUE, se = TRUE)
