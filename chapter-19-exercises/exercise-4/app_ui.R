...
# This layout will contain the following elements:
  ...
  # the US."
    p("The below diagram was created by the New York Times to illustrate the increasing level 
  ...
  # "inequality.png" (which will refer to the file in the `www/` folder).
    img(src = "inequality.png", alt = "inequality graph"), 
...
# containing the following information:
  sidebar_content <- sidebarPanel(
    sliderInput(inputId = "percentile", label = "Income Percwntile",
...
# containing the following information:
  main_content <- mainPanel(
    ...
    p(a(href = "http://gabriel-zucman.eu/usdina/", "http://gabriel-zucman.eu/usdina/"))
  )
